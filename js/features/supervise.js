...
(function () {
    ...
    var PRAISE_LINES = {
        exercise: {
            short: ['运动完啦，真棒。', '又动了动，身体会感谢你的。', '坚持运动，给你点个赞。'],
            long: ['都坚持这么多天了，真的很了不起。', '这么久没断过，你真的很自律。']
        },
        study: {
            short: ['学习辛苦了。', '又是充实的一天。', '认真学习的样子很棒。'],
            long: ['坚持了这么久，真的不容易。', '这份坚持，值得夸一夸。']
        },
        sleep: {
            short: ['早睡早起，真乖。', '作息不错，继续保持。', '按时休息，身体最重要。'],
            long: ['这么多天作息都很规律，很厉害。', '坚持这么久的好作息，真的很棒。']
        }
    };

    var NAG_LINES = {
        exercise: {
            strict: ['今天运动了吗？别偷懒。', '说好的运动呢，别老找借口。', '身体是自己的，动一动。'],
            gentle: ['今天有没有抽空动一动呀？', '别太累着自己，但也别忘了运动哦。', '休息一下，起来活动活动？']
        },
        study: {
            strict: ['今天学习了吗？不能松懈。', '该看的书看了没？', '别老拖着，学习计划呢？'],
            gentle: ['今天有没有看看书呀？', '学习重要，但也别太逼自己。', '有空的话学一点点也好呀。']
        },
        sleep: {
            strict: ['现在几点了还不睡？', '早点睡，别熬夜了。', '说好的早睡呢？'],
            gentle: ['早点休息哦，身体要紧。', '记得早点睡呀，别太晚。', '今天早点睡好不好？']
        }
    };

    var STREAK_BROKEN_LINES = {
        strict: ['唉，还是没坚持住。', '前面的努力有点可惜了。', '断了就断了，下次盯紧点。'],
        gentle: ['没关系，重新开始就好。', '断了也没事，我们再来。', '别灰心，明天继续就好。']
    };
