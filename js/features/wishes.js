...
(function () {
    ...
    var WISH_POOL = {
        ...
        action: [
            '陪我聊聊天，随便聊什么都行', '想看你笑一下', '发一张你现在在做什么的照片',
            '陪我一小会', '告诉我一句喜欢的歌词', '跟我分享一件今天发生的小事',
            '陪我看看今天的天气怎么样', '想知道你在忙什么', '陪我一起安静待一会',
            '跟我说说你现在的心情'
        ]
    };
    var TYPE_META = {
    ...
    var FULFILL_REACTIONS = {
        material: ['谢谢你', '你最好了', '抱抱'],
        emotional: ['心里暖暖的，谢谢你', '谢谢你懂我', '有你在真好'],
        action: ['谢谢你陪我', '感觉好多了，谢谢', '喜欢跟你待在一起']
    };
