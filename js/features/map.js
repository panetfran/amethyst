...
(function () {
    ...
    function createDefaultMapData(key) {
        ...
        var defaults = {
            root: {
                key: 'root',
                locations: [
                    { id: 'me', x: 480, y: 350, name: '我的位置', type: 'me', icon: 'fa-location-dot', color: '#7BC8A4', hasSubmap: false },
                    { id: 'ta', x: 520, y: 350, name: 'TA的位置', type: 'ta', icon: 'fa-heart', color: '#c5a47e', hasSubmap: false },
    ...
    function resetMapToDefault() {
        var tasks = [];
        if (typeof localforage !== 'undefined') {
            tasks.push(localforage.removeItem(getMapStorageKey()).catch(function () {}));
            tasks.push(localforage.removeItem(getNextCheckKey()).catch(function () {}));
        }
