...
(function () {
    ...
    function jumpToPersonLocation(type) {
        try {
            ...
            panOffset.x = canvas.width / 2 / zoomLevel - foundLoc.x;
            panOffset.y = canvas.height / 2 / zoomLevel - foundLoc.y;
            if (typeof showNotification === 'function') {
    ...
    function moveMyLocationTo(targetMapKey, targetLocId) {
        try {
            ...
            if (currentMapKey() === targetMapKey) {
                panOffset.x = canvas.width / 2 / zoomLevel - targetLoc.x;
                panOffset.y = canvas.height / 2 / zoomLevel - targetLoc.y;
            }
            renderTabContent();
