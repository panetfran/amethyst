...
(function () {
    ...
    function createDefaultMapData(key) {
        ...
        var defaults = {
            root: {
                key: 'root',
                locations: [
                    { id: 'me', x: 430, y: 350, name: '我的位置', type: 'me', icon: 'fa-location-dot', color: '#7BC8A4', hasSubmap: false },
                    { id: 'ta', x: 470, y: 350, name: 'TA的位置', type: 'ta', icon: 'fa-heart', color: '#c5a47e', hasSubmap: false },

                    // ── 共享地点（两人都会去）──
                    { id: 'cinema', x: 450, y: 190, name: '电影院', type: 'fun', icon: 'fa-film', color: '#F4A6B3', hasSubmap: false },
                    { id: 'cafe', x: 450, y: 510, name: '咖啡馆', type: 'food', icon: 'fa-mug-hot', color: '#F4A6B3', hasSubmap: false },

                    // ── 我的地点（左侧）──
                    { id: 'my_home', x: 120, y: 120, name: '我的家', type: 'place', icon: 'fa-house', color: '#7BC8A4', hasSubmap: true, submapId: 'my_home' },
                    { id: 'station', x: 300, y: 70, name: '车站', type: 'place', icon: 'fa-train', color: '#7BC8A4', hasSubmap: false },
                    { id: 'my_school', x: 90, y: 300, name: '学校', type: 'place', icon: 'fa-graduation-cap', color: '#7BC8A4', hasSubmap: true, submapId: 'my_school' },
                    { id: 'conv_store', x: 260, y: 190, name: '便利店', type: 'place', icon: 'fa-store', color: '#7BC8A4', hasSubmap: false },
                    { id: 'supermarket', x: 330, y: 260, name: '超市', type: 'place', icon: 'fa-cart-shopping', color: '#7BC8A4', hasSubmap: false },
                    { id: 'dentist', x: 190, y: 370, name: '牙医', type: 'place', icon: 'fa-tooth', color: '#7BC8A4', hasSubmap: false },
                    { id: 'downtown', x: 100, y: 470, name: '市区', type: 'place', icon: 'fa-city', color: '#7BC8A4', hasSubmap: false },
                    { id: 'my_park', x: 280, y: 440, name: '公园', type: 'nature', icon: 'fa-tree', color: '#7BC8A4', hasSubmap: false },
                    { id: 'seaside', x: 360, y: 500, name: '海边', type: 'nature', icon: 'fa-water', color: '#7BC8A4', hasSubmap: false },
                    { id: 'high_place', x: 210, y: 560, name: '城市高处', type: 'place', icon: 'fa-building', color: '#7BC8A4', hasSubmap: false },
                    { id: 'clothes_shop', x: 350, y: 400, name: '服装店', type: 'place', icon: 'fa-shirt', color: '#7BC8A4', hasSubmap: false },

                    // ── 梦角的地点（右侧）──
                    { id: 'ta_home', x: 800, y: 120, name: '梦角的家', type: 'place', icon: 'fa-house', color: '#BB9EC7', hasSubmap: true, submapId: 'ta_home' },
                    { id: 'ta_company', x: 610, y: 90, name: '星际和平公司', type: 'work', icon: 'fa-satellite', color: '#BB9EC7', hasSubmap: true, submapId: 'ta_company' },
                    { id: 'ta_university', x: 870, y: 260, name: '真理大学', type: 'place', icon: 'fa-graduation-cap', color: '#BB9EC7', hasSubmap: true, submapId: 'ta_university' },
                    { id: 'ta_society', x: 700, y: 210, name: '博识学会', type: 'place', icon: 'fa-landmark', color: '#BB9EC7', hasSubmap: false },
                    { id: 'bar', x: 540, y: 550, name: '酒吧', type: 'fun', icon: 'fa-martini-glass', color: '#c5a47e', hasSubmap: false },
                    { id: 'ta_station', x: 610, y: 410, name: '空间站', type: 'work', icon: 'fa-satellite-dish', color: '#BB9EC7', hasSubmap: true, submapId: 'ta_station' },
                    { id: 'greenhouse', x: 790, y: 460, name: '植物园', type: 'nature', icon: 'fa-seedling', color: '#BB9EC7', hasSubmap: false },
                    { id: 'ta_traveling', x: 860, y: 560, name: '出差中·其它星系', type: 'place', icon: 'fa-rocket', color: '#c5a47e', hasSubmap: false, rareTarget: true }
                ],
                routes: [],
                submaps: [
                ...
                terrain: [
                    { x: 0, y: 0, w: 900, h: 700, color: '#eef1e8' },
                    { x: 30, y: 30, w: 380, h: 260, color: '#e3ecdc' },   // 我这边大致区域
                    { x: 500, y: 30, w: 380, h: 260, color: '#efe6ee' }, // 梦角那边大致区域
                    { x: 30, y: 340, w: 380, h: 300, color: '#e3ecdc' },
                    { x: 500, y: 340, w: 380, h: 300, color: '#efe6ee' },
                    { x: 400, y: 150, w: 100, h: 420, color: '#f4ecd8' } // 中间共享地带
                ],
                roads: [],
            ...
            my_home: {
                ...
                locations: [
                    ...
                    { id: 'bedroom', x: 400, y: 150, name: '卧室', type: 'place', icon: 'fa-door-closed', color: '#BB9EC7', hasSubmap: false },
                    ...
                    { id: 'kitchen', x: 400, y: 400, name: '厨房', type: 'food', icon: 'fa-utensils', color: '#F4A6B3', hasSubmap: false },
                ...
                roads: [],
                sharingEnabled: false, privacyShowMe: true, privacyShowTa: true, privacyShowRoutes: true
            },
            ...
            my_school: {
                ...
                locations: [
                    ...
                    { id: 'library', x: 380, y: 220, name: '图书馆', type: 'place', icon: 'fa-book', color: '#7FA6CD', hasSubmap: false }
                ],
                routes: [], submaps: [],
            ...
            ta_home: {
                ...
                locations: [
                    ...
                    { id: 'ta_bedroom', x: 400, y: 150, name: '卧室', type: 'place', icon: 'fa-door-closed', color: '#c5a47e', hasSubmap: false },
                    ...
                    { id: 'ta_kitchen', x: 400, y: 400, name: '厨房', type: 'food', icon: 'fa-utensils', color: '#F4A6B3', hasSubmap: false },
            ...
            ta_company: {
                key: 'ta_company',
                locations: [
                    { id: 'meeting_room', x: 180, y: 220, name: '会议室', type: 'work', icon: 'fa-users', color: '#BB9EC7', hasSubmap: false },
            ...
            ta_university: {
                ...
                locations: [
                    ...
                    { id: 'ta_library', x: 350, y: 300, name: '图书馆', type: 'place', icon: 'fa-book', color: '#BB9EC7', hasSubmap: false }
                ],
                routes: [], submaps: [],
            ...
            ta_station: {
                key: 'ta_station',
                locations: [
                    { id: 'station_meeting', x: 150, y: 150, name: '会议室', type: 'work', icon: 'fa-users', color: '#BB9EC7', hasSubmap: false },
    ...
    function show() {
        ...
        applyTimeFilter();
        if (!_timeFilterTimer) {
            _timeFilterTimer = setInterval(applyTimeFilter, 5 * 60 * 1000); // 每5分钟刷新一次，应对跨时段
        }
    ...
    function applyTimeFilter() {
        ...
        if (hour >= 5 && hour < 8) {
            // 清晨：偏暖的浅橙粉色调
            bg = 'linear-gradient(180deg, rgba(255,200,150,0.18), rgba(255,220,190,0.08))';
        } else if (hour >= 8 && hour < 17) {
            // 白天：不叠加滤镜
            bg = 'transparent';
        } else if (hour >= 17 && hour < 19) {
            // 黄昏：暖橙色调
            bg = 'linear-gradient(180deg, rgba(255,140,80,0.22), rgba(255,180,120,0.1))';
        } else {
            // 夜晚：整体压暗 + 深蓝色调
            bg = 'linear-gradient(180deg, rgba(20,25,60,0.5), rgba(15,20,45,0.42))';
        }
