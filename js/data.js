(function () {
    ...
    var INNER_HTML =
        ...
        +   '<div class="dm-section-label"><i class="fas fa-gift"></i> 礼物盲盒</div>'
        +   '<div class="dm-danger-cards dm-danger-cards-row">'
        +     '<button class="dm-danger-card dm-danger-card-half" id="reset-gift-count-btn">'
        +       '<div class="dm-danger-card-icon"><i class="fas fa-rotate-left"></i></div>'
        +       '<div class="dm-danger-card-body">'
        +         '<div class="dm-danger-card-title">重置今日计数</div>'
        +         '<div class="dm-danger-card-desc">今日可再次收到礼物</div>'
        +       '</div>'
        +     '</button>'
        +     '<button class="dm-danger-card dm-danger-card-half" id="force-send-gift-btn">'
        +       '<div class="dm-danger-card-icon"><i class="fas fa-gift"></i></div>'
        +       '<div class="dm-danger-card-body">'
        +         '<div class="dm-danger-card-title">立即发送礼物</div>'
        +         '<div class="dm-danger-card-desc">测试用，随机送一个</div>'
        +       '</div>'
        +     '</button>'
        +   '</div>'
        ...
        +   '<div class="dm-danger-cards dm-danger-cards-row">'
        +     '<button class="dm-danger-card dm-danger-card-half" id="trigger-quiz-btn">'
        +       '<div class="dm-danger-card-icon"><i class="fas fa-comment-dots"></i></div>'
        +       '<div class="dm-danger-card-body">'
        +         '<div class="dm-danger-card-title">立即弹出一题</div>'
        +         '<div class="dm-danger-card-desc">测试用，跳过每日限制</div>'
        +       '</div>'
        +     '</button>'
        +     '<button class="dm-danger-card dm-danger-card-half" id="reset-quiz-count-btn">'
        +       '<div class="dm-danger-card-icon"><i class="fas fa-rotate-left"></i></div>'
        +       '<div class="dm-danger-card-body">'
        +         '<div class="dm-danger-card-title">重置今日计数</div>'
        +         '<div class="dm-danger-card-desc">今日可再次弹出题目</div>'
        +       '</div>'
        +     '</button>'
        +   '</div>'

        +   '<div class="dm-section-label"><i class="fa-solid fa-face-kiss-wink-heart"></i> 朋友圈</div>'
        +   '<div class="dm-danger-cards dm-danger-cards-row">'
        +     '<button class="dm-danger-card dm-danger-card-full" id="trigger-moment-btn">'
        +       '<div class="dm-danger-card-icon"><i class="fa-solid fa-face-kiss-wink-heart"></i></div>'
        +       '<div class="dm-danger-card-body">'
        +         '<div class="dm-danger-card-title">让对方立即发一条</div>'
        +         '<div class="dm-danger-card-desc">测试用，跳过每日调度</div>'
        +       '</div>'
        +     '</button>'
        +   '</div>'

        +   '<div class="dm-section-label"><i class="fas fa-music"></i> 一起听歌</div>'
        +   '<div class="dm-danger-cards dm-danger-cards-row">'
        +     '<button class="dm-danger-card dm-danger-card-full" id="trigger-music-invite-btn">'
        +       '<div class="dm-danger-card-icon"><i class="fas fa-music"></i></div>'
        +       '<div class="dm-danger-card-body">'
        +         '<div class="dm-danger-card-title">立即邀请一起听歌</div>'
        +         '<div class="dm-danger-card-desc">测试用，跳过随机等待</div>'
        +       '</div>'
        +     '</button>'
        +   '</div>'
