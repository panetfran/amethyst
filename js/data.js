(function () {
    ...
    var INNER_HTML =
        ...
        +   '<div style="display:flex; flex-direction:column; border:1px solid var(--border-color); border-radius:14px; overflow:hidden; margin-bottom:4px; flex-shrink:0;">'

        +     '<div class="dm-test-row" id="force-send-gift-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;border-bottom:1px solid var(--border-color);">'
        ...
        +     '<div class="dm-test-row" id="reset-gift-count-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;border-bottom:1px solid var(--border-color);">'
        ...
        +     '<div class="dm-test-row" id="trigger-quiz-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;border-bottom:1px solid var(--border-color);">'
        ...
        +     '<div class="dm-test-row" id="reset-quiz-count-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;border-bottom:1px solid var(--border-color);">'
        +       '<i class="fas fa-rotate-left" style="width:18px;text-align:center;color:var(--accent-color);opacity:0.85;"></i>'
        ...
        +     '<div class="dm-test-row" id="trigger-moment-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;border-bottom:1px solid var(--border-color);">'
        ...
        +     '<div class="dm-test-row" id="trigger-music-invite-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;">'
        ...
        +     '<div class="dm-test-row" id="trigger-art-paint-btn" style="display:flex;align-items:center;gap:10px;padding:11px 14px;cursor:pointer;flex-shrink:0;min-height:24px;">'
        +       '<i class="fas fa-palette" style="width:18px;text-align:center;color:var(--accent-color);opacity:0.85;"></i>'
        +       '<div style="flex:1;min-width:0;"><div style="font-size:13px;color:var(--text-primary);">立即画一幅画</div><div style="font-size:11px;color:var(--text-secondary);">测试用，跳过随机等待</div></div>'
        +       '<i class="fas fa-chevron-right" style="font-size:11px;color:var(--text-secondary);opacity:0.5;"></i>'
        +     '</div>'
    ...
    function bindAll(mc) {
        ...
        var triggerArtPaintBtn = mc.querySelector('#trigger-art-paint-btn');
        if (triggerArtPaintBtn) triggerArtPaintBtn.addEventListener('click', function () {
            if (typeof window.artPaintNow === 'function') window.artPaintNow();
        });
